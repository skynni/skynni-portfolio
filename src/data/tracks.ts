...
export interface Track {
  ...
  audioId: string;
  audioSrc: string;
  /** Opcjonalna ścieżka do wersji a cappella — wyświetla przełącznik wersji */
  acapellaSrc?: string;
}
...
export const tracks: Track[] = [
  {
    id: 'track-1',
    num: '01',
    title: 'Choose Your Fighter (Polish Cover)',
    genre:
      'Pop - Polski cover utworu Choose Your Fighter w aranżacji inspirowanej światem Hazbin Hotel. Wykonuję w nim finałową partię wokalną, wcielając się w rolę Lucyfera.',
    audioId: 'audio-music-1',
    audioSrc: '/assets/audio/muzyka/choose-your-fighter.mp3',
    acapellaSrc: '/assets/audio/muzyka/choose-your-fighter-acapella.mp3',
  },
  {
    id: 'track-2',
    num: '02',
